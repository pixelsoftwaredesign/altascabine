...
// CABINE : AT-S90 — Cabine S · prix 18500 DT HT
// ARDUINO_LINK = 1 (Ethernet/MQTT)
// ============================================================================

#define CABINE_ID          "AT-S90"
#define ARDUINO_SW         "v2.1-arduino-at-s90"
#define ARDUINO_MODE_DEV   0     // 0 = production (surcharger en dev)

// ---------- Mode de communication ----------
#define ARDUINO_LINK       1     // 1 = Ethernet/MQTT · 2 = pont série Pi

#if ARDUINO_LINK == 1
  byte ARD_MAC[] = { 0xDE, 0xAD, 0xBE, 0xEF, 0x01, 0x01 };
  IPAddress ARD_IP  (10, 0, 1, 31);
...
// ---------- Modules optionnels ----------
#define GPIO_AC         -1    // absent
#define GPIO_CO2_A      -1 // CO2 analogique
