...
// CABINE : AT-M240 — Cabine M · prix 32900 DT HT
// Capacités natives : door, reed, sensor, light, ac, co2
// ============================================================================

#define CABINE_ID            "AT-M240"
#define CABINE_NOM           "Cabine M"
#define CABINE_ROLE          2   // 1 = STANDALONE · 2 = ESCLAVE (Pi câblé)
#define CABINE_MODE_DEV      0   // 0 = production (surcharger en dev)
#define CABINE_SW            "v2.1-at-m240"
